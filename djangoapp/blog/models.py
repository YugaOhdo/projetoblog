...
class Post(models.Model):
    ...
    updated_by = models.ForeignKey(
        ...
        #o nome que chamamos a foreignkey
    )
    ...
    #muitos para muitos em ambas as direções, 1 post pode ter várias tags,
    # 1 tag pode ter vários posts
    #no sql seria uma terceira tabela fazendo a junção
